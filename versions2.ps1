...
$sWeb = "http://srus270113/collaboration/sfa"
$sWebUrl = "http://srus270113/collaboration/sfa"
$dWeb = "http://srus270111"
$temp = "C:\Temp\"
...
$credentials = new-object System.Net.NetworkCredential("zzrus27sp_admin", "bS44rogZ", "ferreronet")

$sLibrary = "ACCENTURE"
$sFolderPath = "/ACCENTURE/06_Build"
$dLibrary = "COLLABORATION"
$dFolderPath = "/COLLABORATION/SFA Project/ACCENTURE/06_Build 2"
...
$usersString = $usersString.Replace('ponomeuge1','')
$usersString = $usersString.Replace('verkhroma1','')
$usersString = $usersString.Replace('panfealex1','')
$usersString = $usersString.Replace('shchemaxi1','')
$usersString = $usersString.Replace('kozlodmit1','')
$usersString = $usersString.Replace('sivkoalek1','')
$usersString = $usersString.Replace('berdnilya1','')
$usersString = $usersString.Replace('reznimiro1','')
